...
<div class="part-link" onclick="window.location.href='posts/frame-graph-theory/'" style="cursor:pointer;padding:.9em 1.3em;border-bottom:1px solid rgba(99,102,241,.07);display:flex;align-items:center;gap:1em;">
...
<div class="part-link" onclick="window.location.href='posts/frame-graph-build-it/'" style="cursor:pointer;padding:.9em 1.3em;border-bottom:1px solid rgba(99,102,241,.07);display:flex;align-items:center;gap:1em;">
